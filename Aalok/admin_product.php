<?php
    ...
    if (isset($_POST['add_product'])) {
        ...
        if(mysqli_num_rows($select_product_name)>0){
            ...
            $insert_product = mysqli_query($conn, "INSERT INTO `products` (`name`,`price`,`products_detail`,`image`) 
...
if (isset($_POST['updte_product'])){
    ...
    `products_detail`= '$update_detail', `image`= '$update_image' WHERE id = '$update_id'") or die('query failed');
     if($update_query){
...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            <?php
                $select_products = mysqli_query($conn, "SELECT * FROM `products`") or die('qurey failed');
            ...
            <div class="box">
                ...
                <details><?php echo $fetch_products['products_detail'];?></details>
    ...
    <section class="update-container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <textarea><?php echo $fetch_edit['products_detail'];?></textarea>
